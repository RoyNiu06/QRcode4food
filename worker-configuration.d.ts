/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 49c74e1eca135cdb2eee72eeeeb9a3e0)
// Runtime types generated with workerd@1.20260921.1 2026-09-22 nodejs_compat
interface __BaseEnv_Env {
	IMAGES: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	APP_ORIGIN: "https://qrcode.royilab.com";
	AUTH_SECRET: string;
	SETUP_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "AUTH_SECRET" | "SETUP_TOKEN">> {}
}
